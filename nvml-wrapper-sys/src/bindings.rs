...
pub mod field_id {
    ...
    pub const NVML_FI_DEV_NVLINK_GET_POWER_THRESHOLD_MAX: u32 = 199;
    pub const NVML_FI_DEV_IS_MIG_MODE_INDEPENDENT_MIG_QUERY_CAPABLE: u32 = 200;
...
pub const nvmlEventTypeAll: u32 = 16287;
